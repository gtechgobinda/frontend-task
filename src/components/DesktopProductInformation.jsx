...
import { DesktopProductInfoWrapper } from "../styles/DesktopProductInformation.Styles";

const DesktopProductInformation = () => {
  return (
    <DesktopProductInfoWrapper>
...
export default DesktopProductInformation;
