...
import { DesktopPriceTableWrapper } from "../styles/DesktopPriceBreakupTable.Style";
const DesktopPriceBreakupTable = () => {
  return (
    <>
      <DesktopPriceTableWrapper>
...
export default DesktopPriceBreakupTable;
